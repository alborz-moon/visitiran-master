                ...
                for (i = 0; i < 12; i += 1) {
                    ...
                    if (!this._jMonthsParse[i]) {
                        ...
                        regex =
                            ...
                            this.jMonths(mom, "") +
                            "|^" +
                            this.jMonthsShort(mom, "");
                        this._jMonthsParse[i] = new RegExp(
                            regex.replace(".", ""),
                            "i"
                        );
                    }
...
************************************/
        ...
        function makeDateFromStringAndFormat(config) {
            ...
            for (i = 0; i < len; i += 1) {
                token = tokens[i];
                parsedInput = (getParseRegexForToken(token, config).exec(
                    string
                ) || [])[0];
                if (parsedInput)
                    string = string.slice(
        ...
        function removeParsedTokens(config) {
            ...
            for (i = 0; i < len; i += 1) {
                ...
                if (parsed)
                    string = string.slice(
                        string.indexOf(parsed) + parsed.length
                    );
...
************************************/
        ...
        jMoment.fn.jDayOfYear = function (input) {
            var dayOfYear =
                Math.round(
                    (jMoment(this).startOf("day") -
                        jMoment(this).startOf("jYear")) /
                        864e5
                ) + 1;
...
************************************/
        ...
        jMoment.loadPersian = function (args) {
            ...
            moment.updateLocale("fa", {
                ...
                weekdays: {
                    persian:
                        "یک\u200cشنبه_دوشنبه_سه\u200cشنبه_چهارشنبه_پنج\u200cشنبه_آدینه_شنبه".split(
                            "_"
                        ),
                    "persian-modern":
                ...
                jMonthsShort: {
                    persian:
                        "فرو_ارد_خرد_تیر_امر_شهر_مهر_آبا_آذر_دی_بهم_اسف".split(
                            "_"
                        ),
                    "persian-modern":
